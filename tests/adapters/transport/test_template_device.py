...
from trcc.adapters.transport.template_device import FrameDevice, LedDevice, UsbDevice
...
class TestHierarchy:
    ...
    def test_hid_type3_is_frame_device(self):
        from trcc.adapters.transport.adapter_hid import HidDeviceType3
    ...
    def test_led_sender_is_led_device(self):
        from trcc.adapters.transport.adapter_led import LedHidSender
