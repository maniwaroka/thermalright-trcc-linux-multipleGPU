...
class TestLCDDriverInit(unittest.TestCase):
    ...
    @patch.object(LCDDriver, '_detect_resolution')
    @patch('trcc.adapters.transport.facade_lcd.detect_devices', return_value=[])
    ...
    @patch.object(LCDDriver, '_detect_resolution')
    @patch('trcc.adapters.transport.facade_lcd.get_default_device')
    ...
    @patch('trcc.adapters.transport.facade_lcd.get_default_device', return_value=None)
...
class TestLCDDriverFrameOps(unittest.TestCase):
    ...
    @patch('trcc.adapters.transport.facade_lcd.rgb_to_bytes', return_value=b'\xFF\x00')
    ...
    @patch('trcc.adapters.transport.adapter_scsi.ScsiDevice._get_frame_chunks', return_value=[(0x10, 100)])
