...
class TestSendImageToDevice(unittest.TestCase):
    ...
    @patch('trcc.adapters.transport.adapter_scsi.ScsiDevice._send_frame')
    @patch('trcc.adapters.transport.adapter_scsi.ScsiDevice._init_device')
    ...
    @patch('trcc.adapters.transport.adapter_scsi.ScsiDevice._send_frame', side_effect=Exception('fail'))
    @patch('trcc.adapters.transport.adapter_scsi.ScsiDevice._init_device')
    ...
    @patch('trcc.adapters.transport.adapter_scsi.ScsiDevice._send_frame')
    @patch('trcc.adapters.transport.adapter_scsi.ScsiDevice._init_device', side_effect=Exception('init fail'))
