...
from trcc.adapters.hardware.facade_linux import (
    _DMI_MEMORY_FIELDS,
    _POLKIT_POLICY,
    _get_smart_health,
    _privileged_cmd,
...
class TestGetMemoryInfo:
    ...
    @patch('trcc.adapters.hardware.facade_linux.subprocess.run')
    @patch('trcc.adapters.hardware.facade_linux._privileged_cmd',
...
class TestGetDiskInfo:
    ...
    @patch('trcc.adapters.hardware.facade_linux._get_smart_health')
    @patch('trcc.adapters.hardware.facade_linux.subprocess.run')
