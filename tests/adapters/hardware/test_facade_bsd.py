...
MODULE = 'trcc.adapters.hardware.facade_bsd'
...
class TestSysctl:
    ...
    def test_reads_value(self, mock_sub):
        ...
        from trcc.adapters.hardware.facade_bsd import _sysctl
...
class TestGetMemoryInfo:
    ...
    def test_parses_physmem(self, mock_sysctl):
        ...
        from trcc.adapters.hardware.facade_bsd import get_memory_info
...
class TestGetDiskInfo:
    ...
    def test_parses_geom_output(self, mock_sub):
        ...
        from trcc.adapters.hardware.facade_bsd import get_disk_info
        disks = get_disk_info()
        assert len(disks) == 1
