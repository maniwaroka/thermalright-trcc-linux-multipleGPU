...
class TestSensorEnumeratorDiscover(unittest.TestCase):
    ...
    @patch('trcc.adapters.sensors.facade_linux.NVML_AVAILABLE', False)
...
class TestSensorEnumeratorReadPsutil(unittest.TestCase):
    ...
    @patch('trcc.adapters.sensors.facade_linux.psutil')
...
class TestMapDefaults(unittest.TestCase):
    ...
    def test_returns_dict(self):
        ...
        from trcc.adapters.sensors.facade_linux import map_defaults
...
class TestDiscoverNvidia(unittest.TestCase):
    ...
    @patch('trcc.adapters.sensors.facade_linux.NVML_AVAILABLE', True)
    @patch('trcc.adapters.sensors.facade_linux.pynvml')
...
class TestNvmlImport(unittest.TestCase):
    ...
    def test_nvml_available_flag_exists(self):
        ...
        from trcc.adapters.sensors.facade_linux import NVML_AVAILABLE
