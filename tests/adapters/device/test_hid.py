...
class TestConstants:
    ...
    def test_type2_magic(self):
        assert bytes([0xDA, 0xDB, 0xDC, 0xDD]) == TYPE2_MAGIC

    def test_type3_cmd_prefix(self):
        assert bytes([0xF5, 0x00, 0x01, 0x00, 0xBC, 0xFF, 0xB6, 0xC8]) == TYPE3_CMD_PREFIX

    def test_type3_frame_prefix(self):
        assert bytes([0xF5, 0x01, 0x01, 0x00, 0xBC, 0xFF, 0xB6, 0xC8]) == TYPE3_FRAME_PREFIX
